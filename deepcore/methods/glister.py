...
class Glister(EarlyTrain):
    def __init__(self, loader, configs, args, robust_learner, fraction=0.5, random_seed=None, epochs=200, specific_model=None,
                 balance: bool = True, greedy="LazyGreedy", eta=None, **kwargs):
        super().__init__(loader, configs, args, robust_learner, fraction, random_seed, epochs, specific_model, **kwargs)
    ...
    def calc_gradient(self, index=None, val=False, record_val_detail=False):
        ...
        batch_loader = self.loader.run('eval_train')
        ...
        for i, data in enumerate(batch_loader):
            ...
            with torch.no_grad():
                ...
                weight_parameters_grads = self.model.embedding_recorder.embedding.view(batch_num, 1, self.embedding_dim).repeat(1, self.num_classes, 1) * \
