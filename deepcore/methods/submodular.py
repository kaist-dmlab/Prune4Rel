...
class Submodular(EarlyTrain):
    def __init__(self, dst_train, args, fraction=0.5, random_seed=None, epochs=200, specific_model=None, balance=False,
                 function="LogDeterminant", greedy="ApproximateLazyGreedy", metric="cossim", dst_train_noTrans=None, **kwargs):
        ...
        self.dst_train_noTrans = dst_train_noTrans
        ...
        with self.model.embedding_recorder:
            ...
            if self.balance:
                ...
                for c in range(self.num_classes):
                    c_indx = self.train_indx[self.dst_train_noTrans.targets == c]
