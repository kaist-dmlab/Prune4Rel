...
def ImageNet9(args):
    ...
    dst_train = MyImageNet9(args.data_path+'/imagenet9/train/', transform=train_transform, resolution=args.resolution)
    dst_test = MyImageNet9(args.data_path+'/imagenet9/val/', transform=test_transform, resolution=args.resolution)
